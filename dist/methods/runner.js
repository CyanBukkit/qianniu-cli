...
const _01_ax_ui_1 = require("./01-ax-ui");
const _02_electron_dc_1 = require("./02-electron-dc");
const _03_applescript_cgwin_1 = require("./03-applescript-cgwin");
const _04_playwright_dc_1 = require("./04-playwright-dc");
const _05_mac_screen_1 = require("./05-mac-screen");
const METHODS = {
    'ax-ui': () => (0, _01_ax_ui_1.detect)(),
    'electron-dc': () => (0, _02_electron_dc_1.detectByElectron)(),
    'applescript-cgwin': () => (0, _03_applescript_cgwin_1.detect)(),
    'playwright-dc': () => (0, _04_playwright_dc_1.detect)(),
    'mac-screen-capture': () => (0, _05_mac_screen_1.detect)(),
};
const METHOD_NAMES = {
...
function printResult(key, result) {
    ...
    if (result.messages && result.messages.length > 0) {
        ...
        result.messages.slice(-3).forEach((m) => {
...
async function runPoll(selected, intervalSec) {
    printBanner();
