...
exports.detectByElectron = detectByElectron;
...
function isElectronAvailable() {
    try {
        const result = (0, child_process_1.execSync)('which electron 2>/dev/null || npx electron --version 2>/dev/null', { encoding: 'utf8', timeout: 10000 });
...
async function detectByElectron() {
    ...
    return new Promise((resolve) => {
        try {
            ...
            try {
                (0, child_process_1.execSync)('which electron', { timeout: 3000 });
            }
            catch {
                electronCmd = 'npx electron';
            }
            const proc = (0, child_process_1.spawn)(electronCmd, [TMP_SCRIPT, '--no-sandbox'], {
                timeout: 15000,
