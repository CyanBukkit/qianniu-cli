...
async function detect() {
  ...
  `;
    try {
        ...
        const output = (0, child_process_1.execSync)(`node ${tmpFile}`, { timeout: 35000, encoding: 'utf8' }).trim();
        try {
            fs.unlinkSync(tmpFile);
        }
        catch { }
