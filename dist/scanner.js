...
exports.scanAllBuyers = scanAllBuyers;
...
// 比例坐标转屏幕坐标
function ratioToScreen(ratioX, ratioY) {
    return {
...
// 通过 AX API 获取买家的买家名称
function getBuyerName(screenX, screenY) {
    // 点击头像选中该买家
    (0, child_process_1.execSync)(`cliclick c:${screenX},${screenY}`, { timeout: 3000 });
  ...
  `;
    try {
        const result = (0, child_process_1.execSync)(`osascript -e '${script}'`, { timeout: 5000, encoding: 'utf8' }).trim();
        return result;
    }
    catch {
        return null;
